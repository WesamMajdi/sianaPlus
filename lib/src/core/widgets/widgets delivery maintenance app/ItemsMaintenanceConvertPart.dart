...
class ItemsMaintenanceConvertPart extends StatelessWidget {
  final ReceiptItemConvertModel item;
  const ItemsMaintenanceConvertPart({
    super.key,
    required this.item,
  });
            ...
            return CustomSureDialog(
              onConfirm: () async {
                ...
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        const ConvertOrderMaintenancesScreen(),
                  ),
                );
              },
            );
