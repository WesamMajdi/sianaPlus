...
class PreviousMaintenanceOrdersTab extends StatelessWidget {
  final OrderEntity orderEntity;
  final OrderState state;
  const PreviousMaintenanceOrdersTab({Key? key, required this.orderEntity, required this.state}) : super(key: key);
