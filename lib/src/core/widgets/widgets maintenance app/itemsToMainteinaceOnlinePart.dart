...
import 'package:maintenance_app/src/features/maintenance%20technician%20app/presentation/screens/maintenance_parts_Online/maintenance_parts_online_details_screen.dart';

class ItemsMaintenanceOnlinePart extends StatelessWidget {
  final OnlineEntity items;
  const ItemsMaintenanceOnlinePart({
    super.key,
    required this.items,
  });
